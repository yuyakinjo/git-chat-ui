      ...
      <div className="flex min-h-0 flex-1 flex-col gap-3 overflow-y-auto px-1 pb-2">
        <div className="grid min-h-0 gap-3 min-[760px]:grid-cols-2 min-[1280px]:grid-cols-4">
          <div className="flex min-h-0 min-w-0 flex-col">
            ...
            <div
              className={`drop-zone min-h-[148px] flex-1 overflow-auto ${dropZone === 'unstaged' ? 'is-over' : ''}`}
              onDragOver={(event) => {
                event.preventDefault();
          ...
          <div className="flex min-h-0 min-w-0 flex-col">
            ...
            <div
              className={`drop-zone min-h-[148px] flex-1 overflow-auto ${dropZone === 'staged' ? 'is-over' : ''}`}
              onDragOver={(event) => {
                event.preventDefault();
                setDropZone('staged');
              }}
          ...
          <div className="flex min-h-0 min-w-0 flex-col">
            ...
            <div
              className={`drop-zone flex min-h-[148px] flex-1 flex-col ${dropZone === 'stash' ? 'is-over' : ''}`}
              onDragOver={(event) => {
                event.preventDefault();
                setDropZone('stash');
              }}
